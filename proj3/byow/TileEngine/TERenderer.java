...
public class TERenderer {
    ...
    public void renderTile(int x, int y, TETile tile, TETile[][] world) {
        StdDraw.enableDoubleBuffering();
    ...
    public void displayTime(TETile[][] world) {
        ...
        if (! time.equals(prevTime)) {
            ...
            StdDraw.filledRectangle(90, 53, 2, 1);
            StdDraw.show();
            StdDraw.setPenColor(Color.WHITE);
            StdDraw.text(90, 53, time);
            prevTime = time;
            StdDraw.show();
        }*/
        ...
        if (!time.equals(prevTime)) {
            ...
            StdDraw.setPenColor(Color.BLACK);
            StdDraw.filledRectangle(80, 53, 6, 1);
            StdDraw.show();
            StdDraw.setPenColor(Color.WHITE);
            StdDraw.text(80, 53, time);
            prevTime = time;
            StdDraw.show();
        }
        StdDraw.setPenColor(Color.WHITE);
    ...
    public void displayElement(int x, int y, TETile[][] tiles) {
        StdDraw.setPenColor(Color.BLACK);
        StdDraw.filledRectangle(20, 53, 6, 1);
        StdDraw.setPenColor(Color.WHITE);
        if (tiles[x][y].equals(Tileset.WALL)) {
            StdDraw.text(20, 53, "wall");
            prevTile = "wall";
        } else if (tiles[x][y].equals(Tileset.FLOOR)) {
            StdDraw.text(20, 53, "floor");
            prevTile = "floor";
        } else if (tiles[x][y].equals(Tileset.AVATAR)) {
            StdDraw.text(20, 53, "avatar");
            prevTile = "avatar";
        } else if (tiles[x][y].equals(Tileset.LOCKED_DOOR)) {
            StdDraw.text(20, 53, "switch");
            prevTile = "switch";
        } else if (tiles[x][y].equals(Tileset.GRASS)) {
            StdDraw.text(20, 53, "wall");
            prevTile = "wall";
        }
    }
